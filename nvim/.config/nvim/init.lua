...
--
-- Author: fjcrujeiras
-- mail: fj@crujeiras.com
--
-- Special thanks to: kickstart.nvim and NvChad for the inspiration
-- ]]
...
-- [[ Options & Preferences ]]
-- Use relativenumber as default
vim.opt.relativenumber = true

-- In case I would want to use number:
-- vim.opt.number = true
...
-- Ensure breakindent is enabled
-- see `:help breakindent`
vim.opt.breakindent = true

-- Set how many spaces equal to a tab
vim.opt.tabstop = 8 -- default
vim.opt.softtabstop = 4 -- default
vim.opt.shiftwidth = 4 -- default
...
-- vim.keymap.set('<mode>', <KeyMap>, <command>, { desc = 'A Description'})
...
require('lazy').setup {
  ...
  { --tmux integration
    'aserowy/tmux.nvim',
    config = function()
      require('tmux').setup { ---@diagnostic disable-line: redundant-parameter
        copy_sync = {
          enable = false, -- disable clipboard sync between tmux and neovim
        },
      }
    end,
  },

  { -- Add colorful indentation lines
  ...
  { -- Render Markdown elements live while editing
